...
public class patientinfo {
    ...
    public patientinfo(String title) {
...
// Column Header
        String[] columns = {"patient_id", "patient_name", "patient_age", "blood_group", "phone_no"};
// Getting Data for Table from Database
        Object[][] data = getpatientinfo();
// Creating JTable object passing data and header
    ...
    private Object[][] getpatientinfo() {
        ...
        final String QUERY = "SELECT patient_id, patient_name, patient_age, blood_group, phone_no FROM bbms.patient_reg;";
        try {
// Loading the Driver
...
// Starting from First Row for Iteration
            ...
            while (rs.next()) {
                ...
                data[i][j++] = rs.getInt("patient_id");

                data[i][j++] = rs.getString("patient_name");

                data[i][j++] = rs.getInt("patient_age");
...
// Closing the Resources;
    ...
    public static void main(String[] args) {
        String title = "patient Details Table";
        patientinfo patient_reg = new patientinfo(title);
